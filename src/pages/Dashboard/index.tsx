  ...
  useEffect(() => {
    const fetchAll = async () => {
      ...
      try {
        ...
        setTotalAirlines(airlineResponse.data.totalItems);
        ...
        setTotalAirports(airportResponse.data.totalItems);
        ...
        setTotalFlights(flightResponse.data.totalItems);

        const userResponse = await axios.get(
          'https://backend-skyfly-c1.vercel.app/api/v1/users',
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        setTotalUsers(userResponse.data.totalItems);
        ...
        setTotalTransactions(transactionResponse.data.totalItems);
      } catch (error) {
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Total Airlines" total={totalAirlines}>
          <svg
        ...
        <CardDataStats title="Total Airports" total={totalAirports}>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="16"
        ...
        <CardDataStats title="Total Flights" total={totalFlights}>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="16"
